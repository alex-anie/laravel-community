<script setup lang="ts">
    ...
    const faqs: FAQ[] = [
        {
        question: 'What does JobMatch do?',
        answer: 'JobMatch is an online platform where you can find job listings for tech jobs. It lists out the latest tech jobs online for users to browse and apply to the ones they like.'
    },
    {
        question: 'Do I need to sign in to apply for jobs on JobMatch?',
        answer: 'No! All jobs are listed out and you are open to apply without creating an account.'
    },
    {
        question: 'How do I post jobs on JobMatch?',
    ...
    },
    {
        ...
        answer: 'No! Posting jobs is completely free on JobMatch.'
    },
    {
        question: 'How do I use JobMatch?',
        answer: 'You can either use JobMatch to look for jobs by browsing the job listings and applying, or you can post a job for hire if you are an employer.'
    },
    {
        question: 'What else can I do with JobMatch?',
...
<template>
    <section class="">
        <h1 class="font-mono text-2xl mt-8">Frequently Asked Question</h1>
        <p class="font-mono text-neutral-500 mb-8">Everything you need to know about JobMatch</p>
