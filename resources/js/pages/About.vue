        ...
        <section class="max-w-4xl mx-auto px-6 py-16">
            ...
            <div class="mb-16">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div class="border border-neutral-300 rounded-lg p-6 hover:border-red-400 transition-colors duration-200">
            ...
            <div class="mb-16">
                ...
                <div class="space-y-4">
                    <div class="flex items-start gap-4 p-4 bg-neutral-50 rounded-lg">
                        <div class="size-8 bg-red-600 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
